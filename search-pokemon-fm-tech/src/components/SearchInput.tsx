  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto">
      ...
      <div className="relative">
        ...
        {/* Limit warning - Minimal style */}
        {showLimitWarning && (
          <div className="absolute bottom-full left-0 right-0 mb-1 z-40 animate-in fade-in duration-200">
            <div className="text-center text-xs font-medium text-amber-600 dark:text-amber-400">
